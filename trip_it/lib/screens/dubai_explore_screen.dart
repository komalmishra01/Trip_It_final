...
class DubaiExploreScreen extends StatelessWidget {
  const DubaiExploreScreen({super.key});

  // Dubai Destination Data (with Perfect Match tag: green)
  static const Destination dubaiDestination = Destination(
    imageName: 'assets/images/dubai.jpg', // ADD THIS IMAGE ASSET
    country: 'UAE',
    city: 'Dubai',
    description: 'Futuristic skyline and luxury. A city of innovation and luxury.',
    price: '\$1299',
    rating: '4.7',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _DestinationCard(destination: dubaiDestination),
          ],
        ),
      ),
    );
